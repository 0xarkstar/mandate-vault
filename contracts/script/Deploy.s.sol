...
/// Deploys the full testnet stack: mocks, oracle, RFQ venue, factory, 3 template
/// vaults. Env: PRIVATE_KEY (deployer), AGENT_ADDRESS (agent EOA).
contract Deploy is Script {
    function run() external {
        ...
        // RFQ venue is the headline execution path; its reserves back the
        // oracle-mid fallback (trip de-risk, withdraw shortfall cover).
        RFQVenue venue = new RFQVenue(IPriceOracle(address(oracle)));
